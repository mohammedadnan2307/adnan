...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"Polynomial Equation Solver/index.js":[function(require,module,exports) {
/* OVERLAY FUNCTIONS */
function openNav() {
...
function submitFunc() {
  if (userOption === "none") {
    ...
    for (var _i = 0; _i < userInput.length; _i++) {
      if (Number.isNaN(Number(userInput[_i])) === true) {
        inputError();
        return false;
      } else {
        coef.push(Number(userInput[_i]));
      }
    }
...
function triggerSubmit() {
  if (submitFunc()) {
    ...
    if (userChoice == 3) {
      ...
      ReactDOM.render(React.createElement("div", null, React.createElement("h2", null, displayMsg), result.length > 1 ? result.map(function (value) {
...
},{}]},{},["C:/Users/Admin/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","Polynomial Equation Solver/index.js"], null)
//# sourceMappingURL=/Polynomial%20Equation%20Solver.b89cb609.js.map